                ...
                if listTransaction[index].type == transactionType {
                    ...
                    for indexPath in 0..<listCategory.count {
                        if listTransaction[index].categoryID == listCategory[indexPath].identify {
                            entries.append(PieChartDataEntry(value: Double(listTransaction[index].money), label: listCategory[indexPath].name))
                            arrCategory.append(listCategory[indexPath].name)
